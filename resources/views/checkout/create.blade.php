          ...
          <div class="col-lg-6 col-12">
            <form action="{{route('checkout.store', $camp->id)}}" class="basic-form" method="post">
              ...
              <div class="mb-4">
                ...
                <input type="text" class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" name="phone" value="{{old('phone') ?: Auth::user()->phone}}" required>
                @if($errors->has('phone'))
              ...
              <div class="mb-4">
                ...
                <input type="text" class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" name="address" value="{{old('address') ?: Auth::user()->address}}" required>
